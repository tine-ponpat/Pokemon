...
function setTypeBackgroundColor(pokemon) {
  ...
  setElementStyles(
    document.querySelectorAll(".pokemon-type > p"),
    "backgroundColor",
    color
  );
...
function displayPokemonDetails(pokemon) {
  ...
  document.querySelector(".name-pokemon .name").textContent =
    capitalizePokemonName;

  document.querySelector(
    ".pokemon-id .body2-fonts"
  ...
  const typeWrapper = document.querySelector(".pokemon-type");
