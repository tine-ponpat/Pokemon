...
const sort_wrapper = document.querySelector(".sort-container");
...
function handleSortIconOnClick() {
  document
    ...
    .classList.toggle("filter-container-open");
  document.querySelector("body").classList.toggle("filter-container-overlay");
}